...
namespace SimpleDrawing
{
    public partial class frmMain : Form
    {
        ...
        {
            System.Windows.Forms.MessageBox.Show("Марко Панайотов, 2101261068");
        }

        private void helpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.MessageBox.Show("При проблеми с проекта се свържете с доц. д-р Светослав Енков");
        }
