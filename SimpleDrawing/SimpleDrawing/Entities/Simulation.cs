    ...
    public static class Simulation
    {
        ...
        private static Double SolveExpression(String expression)
        {
            ...
            if (constant.Success)
            {
                ...
                double constantValue = Double.Parse(constant.Value, CultureInfo.InvariantCulture);
                ...
                if (operation.Success)
                {
                    ...
                    switch (operation.Value)
                    {
                        case "+":
                            {
                                return constantValue + SolveExpression(expression);
                            }
                        case "-":
                            {
                                return constantValue - SolveExpression(expression);
                ...
                {
                    return 0;
                     MessageBox.Show("You have entered an invalid expression! Revise and try again",
